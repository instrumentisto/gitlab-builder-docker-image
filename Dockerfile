...
RUN curl -fL -o /tmp/docker.tar.gz \
         https://download.docker.com/linux/static/edge/x86_64/docker-18.09.2.tgz \
 ...
 && curl -fL -o /usr/local/share/doc/docker/LICENSE \
         https://raw.githubusercontent.com/docker/docker-ce/v18.09.2/components/cli/LICENSE \
    \
 && rm -rf /tmp/*
...
RUN curl -fL -o /usr/local/bin/docker-compose \
 ...
 && curl -fL -o /usr/local/share/doc/docker-compose/LICENSE \
         https://raw.githubusercontent.com/docker/compose/1.23.2/LICENSE \
    \
...
RUN curl -fL -o /usr/local/bin/kubectl \
         https://dl.k8s.io/release/v1.13.3/bin/linux/amd64/kubectl \
 && chmod +x /usr/local/bin/kubectl


# Install Kubernetes Helm.
RUN curl -fL -o /tmp/helm.tar.gz \
         https://kubernetes-helm.storage.googleapis.com/helm-v2.12.3-linux-amd64.tar.gz  \
