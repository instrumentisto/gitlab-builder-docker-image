...
RUN curl -fL -o /tmp/docker.tar.gz \
         https://download.docker.com/linux/static/edge/x86_64/docker-18.04.0-ce.tgz \
 ...
 && curl -fL -o /usr/local/share/doc/docker/LICENSE \
         https://raw.githubusercontent.com/docker/docker-ce/v18.04.0-ce/components/cli/LICENSE \
    \
 && rm -rf /tmp/*
...
RUN curl -fL -o /usr/local/bin/docker-compose \
 ...
 && curl -fL -o /usr/local/share/doc/docker-compose/LICENSE \
         https://raw.githubusercontent.com/docker/compose/1.21.0/LICENSE \
    \
...
RUN curl -fL -o /tmp/helm.tar.gz \
         https://kubernetes-helm.storage.googleapis.com/helm-v2.9.0-linux-amd64.tar.gz  \
